// Hello :)
const grid_container = document.querySelector(".hard_grid_of_buttons");
const mines_element = document.getElementById('mines');
const timer_element = document.getElementById('timer');
const restart_element = document.getElementById("restart");
const ORIGINAL_number_of_bombs=99;
let number_of_bombs = 99;
let displayed_number_of_bombs = 99;
let grid_of_bombs = [];
let rows = 16;
let columns = 30;
